...
sleep '2'
clear
echo "You are ready! Just one last step. Please paste this at the bottom of your .zshrc file: 'dy() {lua ~/Downloads/CoderSerg/dy.lua} ry() {lua ~/Downloads/CoderSerg/ry.lua} yon() {lua ~/Downloads/CoderSerg/yon.lua}"
